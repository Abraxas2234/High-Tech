...
class ClientsController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('clients_show', array('clientId' => $client->getClientid()));
        }
     ...
     *
     * @Route("/{clientId}", name="clients_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{clientId}/edit", name="clients_edit")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/{clientId}", name="clients_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Clients $client)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('clients_delete', array('clientId' => $client->getClientid())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
