...
class __TwigTemplate_58f7239e0f0fce985eab2c4ad5715d6ee03ac96af25b2bc005b4e0f177d4814d extends Twig_Template
{
...
<div id=\"wrapper\">
    <div id=\"container\">
        <div class=\"fos_user_user_show\">
            <p style=\"font-size: 15px;\"><em>{{ 'profile.show.username'|trans }}:</em> {{ user.username }}</p>
            <p style=\"font-size: 15px;\"><em>{{ 'profile.show.email'|trans }}:</em> {{ user.email }}</p>
        </div>
    </div>
</div>", "@FOSUser/Profile/show_content.html.twig", "/opt/lampp/htdocs/High-Tech/app/Resources/FOSUserBundle/views/Profile/show_content.html.twig");
    }
}
