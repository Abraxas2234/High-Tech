...
class FosUser extends \AppBundle\Entity\FosUser implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'username', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'usernameCanonical', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'emailCanonical', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'enabled', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'salt', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'lastLogin', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'confirmationToken', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'passwordRequestedAt', '' . "\0" . 'AppBundle\\Entity\\FosUser' . "\0" . 'roles'];
        }
